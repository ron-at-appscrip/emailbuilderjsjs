...
export default function EmailMarkdown({ markdown, style, ...props }: Props) {
  const data = useMemo(() => renderMarkdownString(markdown), [markdown]);
  return <div {...(props as any)} style={style as React.CSSProperties} dangerouslySetInnerHTML={{ __html: data }} />;
}
